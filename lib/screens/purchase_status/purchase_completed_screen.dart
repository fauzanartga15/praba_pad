// lib/screens/purchase/purchase_completed_screen.dart
...
class PurchaseCompletedScreen extends StatefulWidget {
  const PurchaseCompletedScreen({super.key});

  @override
  State<PurchaseCompletedScreen> createState() =>
      _PurchaseCompletedScreenState();
}

class _PurchaseCompletedScreenState extends State<PurchaseCompletedScreen> {
  ...
  void _loadData() {
    // Generate completed transactions (status selesai)
    _allTransactions = generateSamplePurchaseTransactions(
      filterStatus: TransactionStatus.selesai,
      count: 28,
    );
  }
  ...
  Widget _buildHeader(bool isDarkMode) {
    final totalCompleted = _allTransactions.fold(
      0.0,
      (sum, t) => sum + t.total,
    );
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Pembelian yang telah diselesaikan dan lunas',
                style: TextStyle(
                  fontSize: 14,
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 4),
              Text(
                '${_filteredTransactions.length} selesai',
                style: TextStyle(
                  color: Colors.green,
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(label: _buildColumnHeader('Due', isDarkMode)),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text(
                          'Terbayar Lunas: Rp ${_formatNumber(transaction.terbayar)}',
                          style: TextStyle(
                            color: Colors.green,
                            fontWeight: FontWeight.bold,
                            fontSize: 14,
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            SizedBox(width: 8),
            Text(
              'Export ${_filteredTransactions.length} data selesai berhasil!',
            ),
          ],
        ),
        backgroundColor: Colors.green,
        ...
        content: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('Status', 'LUNAS ✅', statusColor: Colors.green),
              if (transaction.tanggalPenerima != null)
                _buildDetailRow(
                  'Tanggal Penerima',
        ...
        actions: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Cetak invoice untuk ${transaction.id}'),
                  backgroundColor: Colors.green,
                ),
              );
            },
