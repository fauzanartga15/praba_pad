// lib/screens/purchase/purchase_request_screen.dart
...
class _PurchaseRequestScreenState extends State<PurchaseRequestScreen> {
  ...
  void _loadData() {
    // Generate sample data for "Permintaan" status only
    _allTransactions = generateSamplePurchaseTransactions(
      filterStatus: TransactionStatus.permintaan,
      count: 25,
    );
  }
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(Icons.assignment_outlined, size: 32, color: Colors.blue),
        ),
        SizedBox(width: 16),
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Daftar permintaan pembelian yang telah diajukan',
                style: TextStyle(
                  fontSize: 14,
        ...
        Container(
          ...
          child: Text(
            '${_filteredTransactions.length} permintaan',
            style: TextStyle(
              color: Colors.blue,
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            SizedBox(width: 8),
            Text(
              'Export ${_filteredTransactions.length} data permintaan berhasil!',
            ),
          ],
        ),
        backgroundColor: Colors.green,
